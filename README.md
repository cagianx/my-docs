...
Topics covered: domain modeling, architecture (C# / Entity Framework / ASP.NET Core), relational databases (SQLite, SQL Server, PostgreSQL), testing, git workflow, logging, authentication, configuration, environments, and CI/CD pipeline.
