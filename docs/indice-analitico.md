...
- **Audit log HTTP** — [csharp/esempi/http-audit-log](tecnologie/csharp/esempi/02-http-audit-log.md) · [glossario](glossario#audit-log)
...
- **CancellationToken** — [csharp/23-cancellation-token](tecnologie/csharp/concorrenza/23-cancellation-token.md) · [csharp/15-async](tecnologie/csharp/linguaggio/15-async.md) · [csharp/19-background-services](tecnologie/csharp/concorrenza/19-background-services.md)
- **CancellationTokenSource** — [csharp/23-cancellation-token](tecnologie/csharp/concorrenza/23-cancellation-token.md)
- **CreateLinkedTokenSource** — [csharp/23-cancellation-token](tecnologie/csharp/concorrenza/23-cancellation-token.md)
...
- **Eccezioni (log su database con Serilog)** — [csharp/esempi/serilog-db](tecnologie/csharp/esempi/01-serilog-db.md)
- **EfCoreSink** — [csharp/esempi/serilog-db](tecnologie/csharp/esempi/01-serilog-db.md)
...
- **Serilog** — [regole/logging](regole/logging.md) · [csharp/osservabilita/logging](tecnologie/csharp/osservabilita/05-logging.md) · [glossario](glossario#serilog)
- **Serilog su database (sink custom EF)** — [csharp/esempi/serilog-db](tecnologie/csharp/esempi/01-serilog-db.md)
- **Sink (Serilog)** — [csharp/osservabilita/logging](tecnologie/csharp/osservabilita/05-logging.md) · [glossario](glossario#sink-serilog)
